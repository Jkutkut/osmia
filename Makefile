...
doc_watch:
	${DOCKER_RUN_IT} ${RUN_ATTRS} --entrypoint cargo jkutkut/docker4rust watch --clear -x "test --all-features" -x "doc --lib --examples --document-private-items"
